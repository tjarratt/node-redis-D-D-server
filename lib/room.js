function initRoom() {
  ...
  function message(obj){
    ...
    if ("announcement" in obj) {
      ...
      //short circuit when we're the only user that should be annotating
      //if (_isDM) {return;} //TODO: uncomment after isDM is set correctly by the view controller
  ...
  _$canvas.handleDMaction = function(initialPoint) {
    ...
    _dmAction = "shadow"//TODO: create controls that update this
    ...
    if (_dmAction == "annotate") {
      ...
      annotationContext.fillStyle = "rgb(200,0,0)";
      annotationContext.strokeStyle = "red";
      ...
      _$textArea.mousemove(function(e) {
        ...
        var position = findMousePosition(e);
        _annotationContext.fillStyle = "rgb(200,0,0)";//unnecessary?
        _annotationContext.strokeStyle = "red";
      ...
      //eventually we should have an object that handles this, responds to various DM requests
      console.log("shadow time!");
      _shadowContext = $("canvas#shadow")[0].getContext("2d");
      ...
      _$textArea.mousemove(function(e) {
        ...
        _shadowContext.fillStyle = "rgba(200, 200, 200, 0.5)";
        _shadowContext.drawRect(shadowedArea.ul.x, shadowedArea.ul.y, shadowedArea.br.x, shadowedArea.br.y);
      ...
      _$textArea.mouseup(function(e) {
        ...
        _shadowContext.fillStyle = "rgb(200, 200, 200)";
        _shadowContext.drawRect(shadowedArea.ul.x, shadowedArea.ul.y, shadowedArea.br.x, shadowedArea.br.y);
  ...
  function getShadowArea(start, end) {
    ...
    */
    ...
    //upperLeft should be least x, minimum y
    upperLeft.x = start.x < end.x ? start : end;
    upperLeft.y = start.y < end.y ? start : end;
    
    //bottomRight should be max X, min Y
    bottomRight.x = start.x > end.x ? start : end;
    bottomRight.y = start.y > end.y ? start : end;
